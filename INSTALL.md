...
```bash
git clone https://github.com/kr1stj0n/tikap.git
```
...
```bash
cd tikap/web10g-kis-0.13-5.4/
scp ocarina@majora:/home/ocarina/kristjoc/tikap/web10g-kis-0.13-5.4/.config .
make oldconfig
```
...
cd /home/ocarina/kristjoc/tikap/web10g-kis-0.13-5.4/
sudo make install
```
